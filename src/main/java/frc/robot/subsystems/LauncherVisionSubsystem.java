...
public class LauncherVisionSubsystem extends SubsystemBase {
    // double angle;
    double x ;
    double id ;
    double y ;
    ...
    public LauncherVisionSubsystem(){
    ...
    public Command AimAtSpeaker(LauncherSubsystem l_Launcher, Swerve s_Swerve, int id, int offset, DoubleSupplier translationSup, DoubleSupplier strafeSup, BooleanSupplier robotCentricSup)    
    {
        ...
        Command rotateMotorCommand = new LauncherAimCommand(l_Launcher, () -> getRotation(offset));        
        // System.out.println("Rotation: " + getRotation(offset));
        return setPipelineCommand.alongWith(rotateMotorCommand).alongWith(swerveRotateCommand(s_Swerve, id, offset, translationSup,strafeSup, robotCentricSup));
    }
    ...
    public Command swerveRotateCommand(Swerve s_Swerve, int id, int offset, DoubleSupplier translationSup, DoubleSupplier strafeSup, BooleanSupplier robotCentricSup){
    ...
    public Command rotateSwerve(Swerve s_Swerve, int id, double speed){
        Command setPipelineCommand = this.run(
