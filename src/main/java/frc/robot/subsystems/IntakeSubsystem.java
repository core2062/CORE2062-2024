...
public class IntakeSubsystem extends SubsystemBase{
    ...
    public void setFeedAndIntakeSpeed(double intakeSpeed, double feedSpeed){
        leftFeedMotor.set(ControlMode.PercentOutput, intakeSpeed);
        rightFeedMotor.set(ControlMode.PercentOutput, -intakeSpeed);
        
        intakeMotor.set(ControlMode.PercentOutput, feedSpeed);
    }
