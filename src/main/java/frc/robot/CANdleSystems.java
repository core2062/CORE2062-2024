...
public class CANdleSystems extends SubsystemBase {
    ...
    public CANdleSystems(Joystick joy) {
        this.joystick = joy;
    ...
    //     {
    //         case ColorFlow:
    //             m_toAnimate = new ColorFlowAnimation(232, 137, 13, 0, 0.7, LedCount, Direction.Forward);
    //             break;
    //         case Fire:
    //             m_toAnimate = new FireAnimation(.5, 0.7, LedCount, 0.7, 0.5);
    //             break;
    //         case Larson:
    //             m_toAnimate = new LarsonAnimation(158, 249, 130, 0, 1, LedCount, BounceMode.Front, 3);
    //             break;
    //         case Rainbow:
    ...
    //             break;
    //         case SingleFade:
    //             m_toAnimate = new SingleFadeAnimation(90,118, 128, 0, 0.5, LedCount);
    //             break;
    //         case Strobe:
    //             m_toAnimate = new StrobeAnimation(155, 30, 210, 0, 98.0 / 256.0, LedCount);
    //             break;
    //         case Twinkle:
    //             m_toAnimate = new TwinkleAnimation(57, 34, 101, 0, 0.4, LedCount, TwinklePercent.Percent6);
    //             break;
    //         case TwinkleOff:
    //             m_toAnimate = new TwinkleOffAnimation(169, 191, 20, 0, 0.8, LedCount, TwinkleOffPercent.Percent100);
    //             break;
    //         case SetAll:
    //             m_toAnimate = null;
    //             break;
    ...
    public void periodic() {
        ...
        // m_candle.setLEDs((int)(joystick.getRawAxis(XboxController.Axis.kLeftX.value) * 255), 
        //                       (int)(joystick.getRawAxis(XboxController.Axis.kLeftY.value) * 255), 
        //                       (int)(joystick.getRawAxis(XboxController.Axis.kRightX.value) * 255), 0, 0, 8);
        // System.out.println(m_candle.setLEDs((int)(joystick.getRawAxis(XboxController.Axis.kLeftX.value) * 255),
        // (int)(joystick.getRawAxis(XboxController.Axis.kLeftY.value) * 255),
        //                                      (int)(joystick.getRawAxis(XboxController.Axis.kRightX.value) * 255)));
        m_candle.setLEDs(Constants.Light.r.get(0), Constants.Light.g.get(0), Constants.Light.b.get(0), 0, 0, 8);
    }
